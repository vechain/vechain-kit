...
// Mock user address for testing participated in governance
...
const result = await callContractClause({
    ...
    method: 'participatedInGovernance',
    args: [user as `0x${string}`],
});

// Log result but avoid console.log to prevent linter errors
console.error('Galaxy Member participated in governance result:', result);
