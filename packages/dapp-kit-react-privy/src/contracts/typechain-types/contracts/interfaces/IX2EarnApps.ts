...
export interface IX2EarnAppsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addAppModerator"
      | "addCreator"
...
export interface IX2EarnApps extends BaseContract {
  connect(runner?: ContractRunner | null): IX2EarnApps;
  waitForDeployment(): Promise<this>;

  interface: IX2EarnAppsInterface;
