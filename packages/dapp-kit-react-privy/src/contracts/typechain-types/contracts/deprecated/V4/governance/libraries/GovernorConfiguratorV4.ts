...
export interface GovernorConfiguratorV4Interface extends Interface {
  getEvent(
...
export interface GovernorConfiguratorV4 extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorConfiguratorV4;
  waitForDeployment(): Promise<this>;

  interface: GovernorConfiguratorV4Interface;
