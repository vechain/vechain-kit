...
export interface IB3TRGovernorV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface IB3TRGovernorV1 extends BaseContract {
  connect(runner?: ContractRunner | null): IB3TRGovernorV1;
  waitForDeployment(): Promise<this>;

  interface: IB3TRGovernorV1Interface;
