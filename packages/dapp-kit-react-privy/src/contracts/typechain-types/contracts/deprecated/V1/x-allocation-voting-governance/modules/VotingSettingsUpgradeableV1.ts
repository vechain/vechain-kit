...
export interface VotingSettingsUpgradeableV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface VotingSettingsUpgradeableV1 extends BaseContract {
  connect(runner?: ContractRunner | null): VotingSettingsUpgradeableV1;
  waitForDeployment(): Promise<this>;

  interface: VotingSettingsUpgradeableV1Interface;
