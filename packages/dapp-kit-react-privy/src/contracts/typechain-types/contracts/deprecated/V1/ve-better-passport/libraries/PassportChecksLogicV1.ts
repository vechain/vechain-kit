...
export interface PassportChecksLogicV1Interface extends Interface {
  getEvent(
...
export interface PassportChecksLogicV1 extends BaseContract {
  connect(runner?: ContractRunner | null): PassportChecksLogicV1;
  waitForDeployment(): Promise<this>;

  interface: PassportChecksLogicV1Interface;
