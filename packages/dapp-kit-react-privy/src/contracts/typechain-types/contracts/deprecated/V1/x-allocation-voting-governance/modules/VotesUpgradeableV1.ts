...
export interface VotesUpgradeableV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface VotesUpgradeableV1 extends BaseContract {
  connect(runner?: ContractRunner | null): VotesUpgradeableV1;
  waitForDeployment(): Promise<this>;

  interface: VotesUpgradeableV1Interface;
