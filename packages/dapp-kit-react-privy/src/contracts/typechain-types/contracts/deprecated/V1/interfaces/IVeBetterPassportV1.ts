...
export interface IVeBetterPassportV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "acceptDelegation"
...
export interface IVeBetterPassportV1 extends BaseContract {
  connect(runner?: ContractRunner | null): IVeBetterPassportV1;
  waitForDeployment(): Promise<this>;

  interface: IVeBetterPassportV1Interface;
