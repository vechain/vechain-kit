...
export interface PassportPoPScoreLogicV1Interface extends Interface {
...
export interface PassportPoPScoreLogicV1 extends BaseContract {
  connect(runner?: ContractRunner | null): PassportPoPScoreLogicV1;
  waitForDeployment(): Promise<this>;

  interface: PassportPoPScoreLogicV1Interface;
