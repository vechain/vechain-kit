...
export interface VoteEligibilityUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "addApp"
...
export interface VoteEligibilityUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): VoteEligibilityUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: VoteEligibilityUpgradeableInterface;
