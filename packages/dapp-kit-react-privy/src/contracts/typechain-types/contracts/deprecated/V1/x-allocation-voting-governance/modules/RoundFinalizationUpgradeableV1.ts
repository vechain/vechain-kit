...
export interface RoundFinalizationUpgradeableV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface RoundFinalizationUpgradeableV1 extends BaseContract {
  connect(runner?: ContractRunner | null): RoundFinalizationUpgradeableV1;
  waitForDeployment(): Promise<this>;

  interface: RoundFinalizationUpgradeableV1Interface;
