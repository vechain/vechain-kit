...
export declare namespace PassportTypesV2 {
...
export interface IVeBetterPassportV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "acceptDelegation"
  ...
  encodeFunctionData(
    ...
    values: [
      PassportTypesV2.InitializationDataStruct,
      PassportTypesV2.InitializationRoleDataStruct
    ]
  ): string;
  encodeFunctionData(
...
export interface IVeBetterPassportV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IVeBetterPassportV2;
  waitForDeployment(): Promise<this>;

  interface: IVeBetterPassportV2Interface;
  ...
  initialize: TypedContractMethod<
    [
      data: PassportTypesV2.InitializationDataStruct,
      roles: PassportTypesV2.InitializationRoleDataStruct
    ],
    [void],
    "nonpayable"
  >;
