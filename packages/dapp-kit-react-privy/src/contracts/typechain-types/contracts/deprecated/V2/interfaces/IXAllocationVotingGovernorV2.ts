...
export interface IXAllocationVotingGovernorV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface IXAllocationVotingGovernorV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IXAllocationVotingGovernorV2;
  waitForDeployment(): Promise<this>;

  interface: IXAllocationVotingGovernorV2Interface;
