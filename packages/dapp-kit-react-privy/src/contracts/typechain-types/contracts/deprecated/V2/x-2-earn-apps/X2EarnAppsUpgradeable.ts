...
export interface X2EarnAppsUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "addAppModerator"
...
export interface X2EarnAppsUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): X2EarnAppsUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: X2EarnAppsUpgradeableInterface;
