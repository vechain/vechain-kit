...
export interface VoterRewardsV2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface VoterRewardsV2 extends BaseContract {
  connect(runner?: ContractRunner | null): VoterRewardsV2;
  waitForDeployment(): Promise<this>;

  interface: VoterRewardsV2Interface;
