...
export interface X2EarnAppsV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface X2EarnAppsV2 extends BaseContract {
  connect(runner?: ContractRunner | null): X2EarnAppsV2;
  waitForDeployment(): Promise<this>;

  interface: X2EarnAppsV2Interface;
