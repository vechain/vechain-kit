...
export interface IGalaxyMemberV2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IGalaxyMemberV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IGalaxyMemberV2;
  waitForDeployment(): Promise<this>;

  interface: IGalaxyMemberV2Interface;
