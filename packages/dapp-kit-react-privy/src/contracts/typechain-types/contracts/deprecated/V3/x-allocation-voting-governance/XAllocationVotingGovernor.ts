...
export interface XAllocationVotingGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface XAllocationVotingGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): XAllocationVotingGovernor;
  waitForDeployment(): Promise<this>;

  interface: XAllocationVotingGovernorInterface;
