...
export interface ExternalContractsUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface ExternalContractsUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): ExternalContractsUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: ExternalContractsUpgradeableInterface;
