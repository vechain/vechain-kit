...
export interface GovernorQuorumLogicV3Interface extends Interface {
...
export interface GovernorQuorumLogicV3 extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorQuorumLogicV3;
  waitForDeployment(): Promise<this>;

  interface: GovernorQuorumLogicV3Interface;
