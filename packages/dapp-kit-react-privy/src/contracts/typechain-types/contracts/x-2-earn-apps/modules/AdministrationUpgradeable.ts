...
export interface AdministrationUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "MAX_CREATORS"
...
export interface AdministrationUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): AdministrationUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: AdministrationUpgradeableInterface;
