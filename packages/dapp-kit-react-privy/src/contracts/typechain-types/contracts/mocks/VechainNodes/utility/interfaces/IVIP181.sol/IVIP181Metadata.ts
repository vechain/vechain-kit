...
export interface IVIP181MetadataInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IVIP181Metadata extends BaseContract {
  connect(runner?: ContractRunner | null): IVIP181Metadata;
  waitForDeployment(): Promise<this>;

  interface: IVIP181MetadataInterface;
