...
export interface IVIP181EnumerableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IVIP181Enumerable extends BaseContract {
  connect(runner?: ContractRunner | null): IVIP181Enumerable;
  waitForDeployment(): Promise<this>;

  interface: IVIP181EnumerableInterface;
