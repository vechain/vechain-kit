...
export interface ThunderFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addOperator"
      | "addToBlackList"
...
export interface ThunderFactory extends BaseContract {
  connect(runner?: ContractRunner | null): ThunderFactory;
  waitForDeployment(): Promise<this>;

  interface: ThunderFactoryInterface;
