...
import type {
  ...
  RoundEarningsSettingsUpgradeableInterface,
} from "../../../../../../contracts/deprecated/V3/x-allocation-voting-governance/modules/RoundEarningsSettingsUpgradeable";
...
export class RoundEarningsSettingsUpgradeable__factory {
  static readonly abi = _abi;
  static createInterface(): RoundEarningsSettingsUpgradeableInterface {
    return new Interface(_abi) as RoundEarningsSettingsUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as RoundEarningsSettingsUpgradeable;
  }
}
