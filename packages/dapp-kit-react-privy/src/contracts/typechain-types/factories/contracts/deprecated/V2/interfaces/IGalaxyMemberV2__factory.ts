...
import type {
  IGalaxyMemberV2,
  IGalaxyMemberV2Interface,
} from "../../../../../contracts/deprecated/V2/interfaces/IGalaxyMemberV2";
...
export class IGalaxyMemberV2__factory {
  static readonly abi = _abi;
  static createInterface(): IGalaxyMemberV2Interface {
    return new Interface(_abi) as IGalaxyMemberV2Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IGalaxyMemberV2 {
    return new Contract(address, _abi, runner) as unknown as IGalaxyMemberV2;
  }
}
