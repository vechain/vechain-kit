...
import type {
  IXAllocationPoolV2,
  IXAllocationPoolV2Interface,
} from "../../../../../contracts/deprecated/V2/interfaces/IXAllocationPoolV2";
...
export class IXAllocationPoolV2__factory {
  static readonly abi = _abi;
  static createInterface(): IXAllocationPoolV2Interface {
    return new Interface(_abi) as IXAllocationPoolV2Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IXAllocationPoolV2 {
    return new Contract(address, _abi, runner) as unknown as IXAllocationPoolV2;
  }
}
