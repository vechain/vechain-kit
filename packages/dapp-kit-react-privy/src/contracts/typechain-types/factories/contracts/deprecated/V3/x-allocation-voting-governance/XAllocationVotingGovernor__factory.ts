...
import type {
  ...
  XAllocationVotingGovernorInterface,
} from "../../../../../contracts/deprecated/V3/x-allocation-voting-governance/XAllocationVotingGovernor";
...
export class XAllocationVotingGovernor__factory {
  static readonly abi = _abi;
  static createInterface(): XAllocationVotingGovernorInterface {
    return new Interface(_abi) as XAllocationVotingGovernorInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as XAllocationVotingGovernor;
  }
}
