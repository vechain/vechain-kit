...
import type {
  IEmissionsV1,
  IEmissionsV1Interface,
} from "../../../../../contracts/deprecated/V1/interfaces/IEmissionsV1";
    ...
    outputs: [
      {
        ...
        internalType: "struct IEmissionsV1.Emission",
        name: "",
        type: "tuple",
      },
    ],
...
export class IEmissionsV1__factory {
  static readonly abi = _abi;
  static createInterface(): IEmissionsV1Interface {
    return new Interface(_abi) as IEmissionsV1Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IEmissionsV1 {
    return new Contract(address, _abi, runner) as unknown as IEmissionsV1;
  }
}
