...
import type {
  ...
  AdministrationUpgradeableInterface,
} from "../../../../../../contracts/deprecated/V2/x-2-earn-apps/modules/AdministrationUpgradeable";
...
export class AdministrationUpgradeable__factory {
  static readonly abi = _abi;
  static createInterface(): AdministrationUpgradeableInterface {
    return new Interface(_abi) as AdministrationUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as AdministrationUpgradeable;
  }
}
