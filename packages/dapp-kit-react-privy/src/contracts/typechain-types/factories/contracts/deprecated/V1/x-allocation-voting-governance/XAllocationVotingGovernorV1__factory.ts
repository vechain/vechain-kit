...
import type {
  ...
  XAllocationVotingGovernorV1Interface,
} from "../../../../../contracts/deprecated/V1/x-allocation-voting-governance/XAllocationVotingGovernorV1";
...
export class XAllocationVotingGovernorV1__factory {
  static readonly abi = _abi;
  static createInterface(): XAllocationVotingGovernorV1Interface {
    return new Interface(_abi) as XAllocationVotingGovernorV1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as XAllocationVotingGovernorV1;
  }
}
