...
} from "../../../contracts/templates/BaseUpgradeable";
...
type BaseUpgradeableConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: BaseUpgradeableConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class BaseUpgradeable__factory extends ContractFactory {
  constructor(...args: BaseUpgradeableConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): BaseUpgradeable__factory {
    return super.connect(runner) as BaseUpgradeable__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): BaseUpgradeableInterface {
    return new Interface(_abi) as BaseUpgradeableInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): BaseUpgradeable {
    return new Contract(address, _abi, runner) as unknown as BaseUpgradeable;
  }
}
