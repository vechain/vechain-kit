...
export interface VotesQuorumFractionUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface VotesQuorumFractionUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): VotesQuorumFractionUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: VotesQuorumFractionUpgradeableInterface;
