...
export interface RoundEarningsSettingsUpgradeableV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface RoundEarningsSettingsUpgradeableV1 extends BaseContract {
  connect(runner?: ContractRunner | null): RoundEarningsSettingsUpgradeableV1;
  waitForDeployment(): Promise<this>;

  interface: RoundEarningsSettingsUpgradeableV1Interface;
