...
export interface RoundsStorageUpgradeableV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface RoundsStorageUpgradeableV1 extends BaseContract {
  connect(runner?: ContractRunner | null): RoundsStorageUpgradeableV1;
  waitForDeployment(): Promise<this>;

  interface: RoundsStorageUpgradeableV1Interface;
