...
export interface IX2EarnRewardsPoolV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "availableFunds"
      | "deposit"
...
export interface IX2EarnRewardsPoolV1 extends BaseContract {
  connect(runner?: ContractRunner | null): IX2EarnRewardsPoolV1;
  waitForDeployment(): Promise<this>;

  interface: IX2EarnRewardsPoolV1Interface;
