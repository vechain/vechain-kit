...
export declare namespace GalaxyMemberV1 {
...
export interface GalaxyMemberV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    ...
    values: [GalaxyMemberV1.InitializationDataStruct]
  ): string;
  encodeFunctionData(
...
export interface GalaxyMemberV1 extends BaseContract {
  connect(runner?: ContractRunner | null): GalaxyMemberV1;
  waitForDeployment(): Promise<this>;

  interface: GalaxyMemberV1Interface;
  ...
  initialize: TypedContractMethod<
    [data: GalaxyMemberV1.InitializationDataStruct],
    [void],
    "nonpayable"
  >;
