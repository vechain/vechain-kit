...
export interface IX2EarnRewardsPoolV4Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "availableFunds"
      | "buildProof"
...
export interface IX2EarnRewardsPoolV4 extends BaseContract {
  connect(runner?: ContractRunner | null): IX2EarnRewardsPoolV4;
  waitForDeployment(): Promise<this>;

  interface: IX2EarnRewardsPoolV4Interface;
