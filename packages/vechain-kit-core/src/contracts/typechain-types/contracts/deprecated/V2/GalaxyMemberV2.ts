...
export declare namespace GalaxyMemberV2 {
...
export interface GalaxyMemberV2Interface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    ...
    values: [GalaxyMemberV2.InitializationDataStruct]
  ): string;
  encodeFunctionData(
...
export interface GalaxyMemberV2 extends BaseContract {
  connect(runner?: ContractRunner | null): GalaxyMemberV2;
  waitForDeployment(): Promise<this>;

  interface: GalaxyMemberV2Interface;
  ...
  getSelectedTokenInfoByOwner: TypedContractMethod<
    [owner: AddressLike],
    [GalaxyMemberV2.TokenInfoStructOutput],
    "view"
  >;
  ...
  initialize: TypedContractMethod<
    [data: GalaxyMemberV2.InitializationDataStruct],
    [void],
    "nonpayable"
  >;
