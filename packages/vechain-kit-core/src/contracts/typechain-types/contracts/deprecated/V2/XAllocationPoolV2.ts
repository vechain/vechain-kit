...
export interface XAllocationPoolV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
...
export interface XAllocationPoolV2 extends BaseContract {
  connect(runner?: ContractRunner | null): XAllocationPoolV2;
  waitForDeployment(): Promise<this>;

  interface: XAllocationPoolV2Interface;
