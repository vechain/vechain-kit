...
export interface X2EarnRewardsPoolV2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface X2EarnRewardsPoolV2 extends BaseContract {
  connect(runner?: ContractRunner | null): X2EarnRewardsPoolV2;
  waitForDeployment(): Promise<this>;

  interface: X2EarnRewardsPoolV2Interface;
