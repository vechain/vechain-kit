...
export interface X2EarnRewardsPoolV3Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface X2EarnRewardsPoolV3 extends BaseContract {
  connect(runner?: ContractRunner | null): X2EarnRewardsPoolV3;
  waitForDeployment(): Promise<this>;

  interface: X2EarnRewardsPoolV3Interface;
