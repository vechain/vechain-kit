...
export interface X2EarnRewardsPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface X2EarnRewardsPool extends BaseContract {
  connect(runner?: ContractRunner | null): X2EarnRewardsPool;
