...
export interface GovernorConfiguratorInterface extends Interface {
  getEvent(
...
export interface GovernorConfigurator extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorConfigurator;
  waitForDeployment(): Promise<this>;

  interface: GovernorConfiguratorInterface;
