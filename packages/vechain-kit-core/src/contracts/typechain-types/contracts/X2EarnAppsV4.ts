...
export interface X2EarnAppsV4Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface X2EarnAppsV4 extends BaseContract {
  connect(runner?: ContractRunner | null): X2EarnAppsV4;
  waitForDeployment(): Promise<this>;

  interface: X2EarnAppsV4Interface;
