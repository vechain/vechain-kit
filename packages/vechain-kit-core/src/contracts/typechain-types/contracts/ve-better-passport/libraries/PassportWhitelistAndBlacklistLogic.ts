...
export interface PassportWhitelistAndBlacklistLogicInterface extends Interface {
  getEvent(
...
export interface PassportWhitelistAndBlacklistLogic extends BaseContract {
  connect(runner?: ContractRunner | null): PassportWhitelistAndBlacklistLogic;
  waitForDeployment(): Promise<this>;

  interface: PassportWhitelistAndBlacklistLogicInterface;
