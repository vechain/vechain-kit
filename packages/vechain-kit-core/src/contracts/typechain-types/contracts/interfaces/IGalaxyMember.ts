...
export interface IGalaxyMemberInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IGalaxyMember extends BaseContract {
  connect(runner?: ContractRunner | null): IGalaxyMember;
  waitForDeployment(): Promise<this>;

  interface: IGalaxyMemberInterface;
