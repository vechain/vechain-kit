...
import type {
  XAccessControl,
  XAccessControlInterface,
} from "../../../../contracts/mocks/VechainNodes/XAccessControl";
...
type XAccessControlConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: XAccessControlConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class XAccessControl__factory extends ContractFactory {
  constructor(...args: XAccessControlConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): XAccessControl__factory {
    return super.connect(runner) as XAccessControl__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): XAccessControlInterface {
    return new Interface(_abi) as XAccessControlInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): XAccessControl {
    return new Contract(address, _abi, runner) as unknown as XAccessControl;
  }
}
