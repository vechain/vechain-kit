...
import type {
  ...
  VotingSettingsUpgradeableInterface,
} from "../../../../../../contracts/deprecated/V3/x-allocation-voting-governance/modules/VotingSettingsUpgradeable";
...
export class VotingSettingsUpgradeable__factory {
  static readonly abi = _abi;
  static createInterface(): VotingSettingsUpgradeableInterface {
    return new Interface(_abi) as VotingSettingsUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as VotingSettingsUpgradeable;
  }
}
