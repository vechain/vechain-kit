...
import type {
  ...
  ExternalContractsUpgradeableInterface,
} from "../../../../../../contracts/deprecated/V3/x-allocation-voting-governance/modules/ExternalContractsUpgradeable";
...
export class ExternalContractsUpgradeable__factory {
  static readonly abi = _abi;
  static createInterface(): ExternalContractsUpgradeableInterface {
    return new Interface(_abi) as ExternalContractsUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ExternalContractsUpgradeable;
  }
}
