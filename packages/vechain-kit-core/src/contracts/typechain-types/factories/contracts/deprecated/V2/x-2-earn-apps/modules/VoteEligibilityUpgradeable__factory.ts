...
import type {
  ...
  VoteEligibilityUpgradeableInterface,
} from "../../../../../../contracts/deprecated/V2/x-2-earn-apps/modules/VoteEligibilityUpgradeable";
...
export class VoteEligibilityUpgradeable__factory {
  static readonly abi = _abi;
  static createInterface(): VoteEligibilityUpgradeableInterface {
    return new Interface(_abi) as VoteEligibilityUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as VoteEligibilityUpgradeable;
  }
}
