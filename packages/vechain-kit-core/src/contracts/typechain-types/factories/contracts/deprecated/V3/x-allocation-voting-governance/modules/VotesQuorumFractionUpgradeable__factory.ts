...
import type {
  ...
  VotesQuorumFractionUpgradeableInterface,
} from "../../../../../../contracts/deprecated/V3/x-allocation-voting-governance/modules/VotesQuorumFractionUpgradeable";
...
export class VotesQuorumFractionUpgradeable__factory {
  static readonly abi = _abi;
  static createInterface(): VotesQuorumFractionUpgradeableInterface {
    return new Interface(_abi) as VotesQuorumFractionUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as VotesQuorumFractionUpgradeable;
  }
}
