...
import type {
  ...
  RoundsStorageUpgradeableV1Interface,
} from "../../../../../../contracts/deprecated/V1/x-allocation-voting-governance/modules/RoundsStorageUpgradeableV1";
...
export class RoundsStorageUpgradeableV1__factory {
  static readonly abi = _abi;
  static createInterface(): RoundsStorageUpgradeableV1Interface {
    return new Interface(_abi) as RoundsStorageUpgradeableV1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as RoundsStorageUpgradeableV1;
  }
}
