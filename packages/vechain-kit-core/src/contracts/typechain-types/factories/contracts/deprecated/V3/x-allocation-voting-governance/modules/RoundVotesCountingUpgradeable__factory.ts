...
import type {
  ...
  RoundVotesCountingUpgradeableInterface,
} from "../../../../../../contracts/deprecated/V3/x-allocation-voting-governance/modules/RoundVotesCountingUpgradeable";
...
export class RoundVotesCountingUpgradeable__factory {
  static readonly abi = _abi;
  static createInterface(): RoundVotesCountingUpgradeableInterface {
    return new Interface(_abi) as RoundVotesCountingUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as RoundVotesCountingUpgradeable;
  }
}
