...
} from "../../../contracts/templates/ModuleInitializable";
...
type ModuleInitializableConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ModuleInitializableConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ModuleInitializable__factory extends ContractFactory {
  constructor(...args: ModuleInitializableConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): ModuleInitializable__factory {
    return super.connect(runner) as ModuleInitializable__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ModuleInitializableInterface {
    return new Interface(_abi) as ModuleInitializableInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ModuleInitializable;
  }
}
