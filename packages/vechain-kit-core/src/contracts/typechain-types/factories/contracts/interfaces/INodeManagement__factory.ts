...
import type {
  INodeManagement,
  INodeManagementInterface,
} from "../../../contracts/interfaces/INodeManagement";
...
export class INodeManagement__factory {
  static readonly abi = _abi;
  static createInterface(): INodeManagementInterface {
    return new Interface(_abi) as INodeManagementInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): INodeManagement {
    return new Contract(address, _abi, runner) as unknown as INodeManagement;
  }
}
