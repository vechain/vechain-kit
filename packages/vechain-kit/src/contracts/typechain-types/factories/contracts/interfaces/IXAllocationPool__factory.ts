...
import type {
  IXAllocationPool,
  IXAllocationPoolInterface,
} from "../../../contracts/interfaces/IXAllocationPool";
...
export class IXAllocationPool__factory {
  static readonly abi = _abi;
  static createInterface(): IXAllocationPoolInterface {
    return new Interface(_abi) as IXAllocationPoolInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IXAllocationPool {
    return new Contract(address, _abi, runner) as unknown as IXAllocationPool;
  }
}
