...
import type {
  IEmissions,
  IEmissionsInterface,
} from "../../../contracts/interfaces/IEmissions";
    ...
    outputs: [
      {
        ...
        internalType: "struct IEmissions.Emission",
        name: "",
        type: "tuple",
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: "struct IEmissions.InitializationData",
        name: "data",
        type: "tuple",
      },
    ],
...
export class IEmissions__factory {
  static readonly abi = _abi;
  static createInterface(): IEmissionsInterface {
    return new Interface(_abi) as IEmissionsInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IEmissions {
    return new Contract(address, _abi, runner) as unknown as IEmissions;
  }
}
