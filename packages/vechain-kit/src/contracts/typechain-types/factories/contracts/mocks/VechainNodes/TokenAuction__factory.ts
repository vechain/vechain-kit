...
import type {
  TokenAuction,
  TokenAuctionInterface,
} from "../../../../contracts/mocks/VechainNodes/TokenAuction";
...
type TokenAuctionConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: TokenAuctionConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class TokenAuction__factory extends ContractFactory {
  constructor(...args: TokenAuctionConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): TokenAuction__factory {
    return super.connect(runner) as TokenAuction__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): TokenAuctionInterface {
    return new Interface(_abi) as TokenAuctionInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): TokenAuction {
    return new Contract(address, _abi, runner) as unknown as TokenAuction;
  }
}
