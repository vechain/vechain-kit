...
import type {
  IB3TRGovernor,
  IB3TRGovernorInterface,
} from "../../../../../contracts/deprecated/V3/interfaces/IB3TRGovernor";
...
export class IB3TRGovernor__factory {
  static readonly abi = _abi;
  static createInterface(): IB3TRGovernorInterface {
    return new Interface(_abi) as IB3TRGovernorInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IB3TRGovernor {
    return new Contract(address, _abi, runner) as unknown as IB3TRGovernor;
  }
}
