...
import type {
  ...
  ExternalContractsUpgradeableV1Interface,
} from "../../../../../../contracts/deprecated/V1/x-allocation-voting-governance/modules/ExternalContractsUpgradeableV1";
...
export class ExternalContractsUpgradeableV1__factory {
  static readonly abi = _abi;
  static createInterface(): ExternalContractsUpgradeableV1Interface {
    return new Interface(_abi) as ExternalContractsUpgradeableV1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ExternalContractsUpgradeableV1;
  }
}
