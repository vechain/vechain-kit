...
export interface IVoterRewardsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "UPGRADER_ROLE"
...
export interface IVoterRewards extends BaseContract {
  connect(runner?: ContractRunner | null): IVoterRewards;
  waitForDeployment(): Promise<this>;

  interface: IVoterRewardsInterface;
