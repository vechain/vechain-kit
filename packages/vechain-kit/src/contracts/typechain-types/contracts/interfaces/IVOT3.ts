...
export interface IVOT3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "convertToB3TR",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "convertToVOT3",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "convertedB3trOf",
    values: [AddressLike]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "getPastQuadraticVotingPower",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface IVOT3 extends BaseContract {
  connect(runner?: ContractRunner | null): IVOT3;
  waitForDeployment(): Promise<this>;

  interface: IVOT3Interface;
  ...
  convertToB3TR: TypedContractMethod<
    [amount: BigNumberish],
    [void],
    "nonpayable"
  >;

  convertToVOT3: TypedContractMethod<
    [amount: BigNumberish],
    [void],
    "nonpayable"
  >;

  convertedB3trOf: TypedContractMethod<
    [account: AddressLike],
    [bigint],
    "view"
  >;
  ...
  getPastQuadraticVotingPower: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "convertToB3TR"
  ): TypedContractMethod<[amount: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "convertToVOT3"
  ): TypedContractMethod<[amount: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "convertedB3trOf"
  ): TypedContractMethod<[account: AddressLike], [bigint], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "getPastQuadraticVotingPower"
  ): TypedContractMethod<
    [account: AddressLike, timepoint: BigNumberish],
    [bigint],
    "view"
