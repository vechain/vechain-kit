...
export interface MockENSInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "isApprovedForAll"
      | "owner"
...
export interface MockENS extends BaseContract {
  connect(runner?: ContractRunner | null): MockENS;
  waitForDeployment(): Promise<this>;

  interface: MockENSInterface;
