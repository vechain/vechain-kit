...
export interface VotingSettingsUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface VotingSettingsUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): VotingSettingsUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: VotingSettingsUpgradeableInterface;
