...
export interface GovernorProposalLogicV4Interface extends Interface {
  getEvent(
...
export interface GovernorProposalLogicV4 extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorProposalLogicV4;
  waitForDeployment(): Promise<this>;

  interface: GovernorProposalLogicV4Interface;
