...
export interface RoundEarningsSettingsUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface RoundEarningsSettingsUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): RoundEarningsSettingsUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: RoundEarningsSettingsUpgradeableInterface;
