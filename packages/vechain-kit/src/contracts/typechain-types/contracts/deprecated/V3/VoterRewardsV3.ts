...
export interface VoterRewardsV3Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface VoterRewardsV3 extends BaseContract {
  connect(runner?: ContractRunner | null): VoterRewardsV3;
  waitForDeployment(): Promise<this>;

  interface: VoterRewardsV3Interface;
