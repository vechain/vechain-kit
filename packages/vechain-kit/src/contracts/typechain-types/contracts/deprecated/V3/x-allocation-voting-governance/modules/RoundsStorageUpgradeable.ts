...
export interface RoundsStorageUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface RoundsStorageUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): RoundsStorageUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: RoundsStorageUpgradeableInterface;
