...
export interface GovernorProposalLogicV3Interface extends Interface {
  getEvent(
...
export interface GovernorProposalLogicV3 extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorProposalLogicV3;
  waitForDeployment(): Promise<this>;

  interface: GovernorProposalLogicV3Interface;
