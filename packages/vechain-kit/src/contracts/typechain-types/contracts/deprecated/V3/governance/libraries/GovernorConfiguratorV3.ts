...
export interface GovernorConfiguratorV3Interface extends Interface {
  getEvent(
...
export interface GovernorConfiguratorV3 extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorConfiguratorV3;
  waitForDeployment(): Promise<this>;

  interface: GovernorConfiguratorV3Interface;
