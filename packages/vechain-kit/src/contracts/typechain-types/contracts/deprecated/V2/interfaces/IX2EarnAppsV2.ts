...
export interface IX2EarnAppsV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addAppModerator"
      | "addCreator"
...
export interface IX2EarnAppsV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IX2EarnAppsV2;
  waitForDeployment(): Promise<this>;

  interface: IX2EarnAppsV2Interface;
