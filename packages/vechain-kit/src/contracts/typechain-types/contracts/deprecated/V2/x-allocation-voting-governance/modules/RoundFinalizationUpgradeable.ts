...
export interface RoundFinalizationUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface RoundFinalizationUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): RoundFinalizationUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: RoundFinalizationUpgradeableInterface;
