...
export interface B3TRGovernorV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
...
export interface B3TRGovernorV2 extends BaseContract {
  connect(runner?: ContractRunner | null): B3TRGovernorV2;
  waitForDeployment(): Promise<this>;

  interface: B3TRGovernorV2Interface;
