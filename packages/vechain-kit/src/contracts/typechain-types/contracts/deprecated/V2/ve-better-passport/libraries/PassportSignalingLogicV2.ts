...
export interface PassportSignalingLogicV2Interface extends Interface {
  getEvent(
...
export interface PassportSignalingLogicV2 extends BaseContract {
  connect(runner?: ContractRunner | null): PassportSignalingLogicV2;
  waitForDeployment(): Promise<this>;

  interface: PassportSignalingLogicV2Interface;
