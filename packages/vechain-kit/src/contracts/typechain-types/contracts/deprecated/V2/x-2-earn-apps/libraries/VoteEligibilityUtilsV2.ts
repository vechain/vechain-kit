...
export interface VoteEligibilityUtilsV2Interface extends Interface {
...
export interface VoteEligibilityUtilsV2 extends BaseContract {
  connect(runner?: ContractRunner | null): VoteEligibilityUtilsV2;
  waitForDeployment(): Promise<this>;

  interface: VoteEligibilityUtilsV2Interface;
