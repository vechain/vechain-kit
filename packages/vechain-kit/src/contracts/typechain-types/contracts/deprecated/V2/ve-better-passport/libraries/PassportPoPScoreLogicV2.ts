...
export interface PassportPoPScoreLogicV2Interface extends Interface {
...
export interface PassportPoPScoreLogicV2 extends BaseContract {
  connect(runner?: ContractRunner | null): PassportPoPScoreLogicV2;
  waitForDeployment(): Promise<this>;

  interface: PassportPoPScoreLogicV2Interface;
