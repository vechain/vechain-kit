...
export interface PassportEntityLogicV1Interface extends Interface {
  getEvent(
...
export interface PassportEntityLogicV1 extends BaseContract {
  connect(runner?: ContractRunner | null): PassportEntityLogicV1;
  waitForDeployment(): Promise<this>;

  interface: PassportEntityLogicV1Interface;
