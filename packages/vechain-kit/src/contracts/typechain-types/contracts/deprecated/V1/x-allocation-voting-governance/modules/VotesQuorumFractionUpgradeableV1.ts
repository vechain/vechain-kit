...
export interface VotesQuorumFractionUpgradeableV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface VotesQuorumFractionUpgradeableV1 extends BaseContract {
  connect(runner?: ContractRunner | null): VotesQuorumFractionUpgradeableV1;
  waitForDeployment(): Promise<this>;

  interface: VotesQuorumFractionUpgradeableV1Interface;
