...
export interface RoundVotesCountingUpgradeableV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface RoundVotesCountingUpgradeableV1 extends BaseContract {
  connect(runner?: ContractRunner | null): RoundVotesCountingUpgradeableV1;
  waitForDeployment(): Promise<this>;

  interface: RoundVotesCountingUpgradeableV1Interface;
