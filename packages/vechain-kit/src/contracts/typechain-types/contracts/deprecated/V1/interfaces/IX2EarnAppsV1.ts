...
export interface IX2EarnAppsV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addApp"
      | "addAppModerator"
...
export interface IX2EarnAppsV1 extends BaseContract {
  connect(runner?: ContractRunner | null): IX2EarnAppsV1;
  waitForDeployment(): Promise<this>;

  interface: IX2EarnAppsV1Interface;
  ...
  hashAppName: TypedContractMethod<[name: string], [string], "view">;
