...
export interface GovernorQuorumLogicV1Interface extends Interface {
...
export interface GovernorQuorumLogicV1 extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorQuorumLogicV1;
  waitForDeployment(): Promise<this>;

  interface: GovernorQuorumLogicV1Interface;
