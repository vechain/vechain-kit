...
export interface IVoterRewardsV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "UPGRADER_ROLE"
...
export interface IVoterRewardsV1 extends BaseContract {
  connect(runner?: ContractRunner | null): IVoterRewardsV1;
  waitForDeployment(): Promise<this>;

  interface: IVoterRewardsV1Interface;
