...
export interface XAllocationVotingGovernorV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface XAllocationVotingGovernorV1 extends BaseContract {
  connect(runner?: ContractRunner | null): XAllocationVotingGovernorV1;
  waitForDeployment(): Promise<this>;

  interface: XAllocationVotingGovernorV1Interface;
