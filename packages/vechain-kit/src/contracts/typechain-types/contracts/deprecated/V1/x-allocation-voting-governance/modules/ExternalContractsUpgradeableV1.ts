...
export interface ExternalContractsUpgradeableV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface ExternalContractsUpgradeableV1 extends BaseContract {
  connect(runner?: ContractRunner | null): ExternalContractsUpgradeableV1;
  waitForDeployment(): Promise<this>;

  interface: ExternalContractsUpgradeableV1Interface;
