...
export interface IXAllocationVotingGovernorV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface IXAllocationVotingGovernorV1 extends BaseContract {
  connect(runner?: ContractRunner | null): IXAllocationVotingGovernorV1;
  waitForDeployment(): Promise<this>;

  interface: IXAllocationVotingGovernorV1Interface;
