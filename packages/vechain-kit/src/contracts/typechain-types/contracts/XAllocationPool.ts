...
export interface XAllocationPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
...
export interface XAllocationPool extends BaseContract {
  connect(runner?: ContractRunner | null): XAllocationPool;
