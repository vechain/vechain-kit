...
export interface GovernorQuorumLogicInterface extends Interface {
...
export interface GovernorQuorumLogic extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorQuorumLogic;
  waitForDeployment(): Promise<this>;

  interface: GovernorQuorumLogicInterface;
