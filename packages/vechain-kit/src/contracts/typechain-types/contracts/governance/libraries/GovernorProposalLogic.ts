...
export interface GovernorProposalLogicInterface extends Interface {
  getEvent(
...
export interface GovernorProposalLogic extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorProposalLogic;
