...
import { DAppKitProvider } from '@vechain/dapp-kit-react2';
...
import { type WalletConnectOptions } from '@vechain/dapp-kit-react2';
import {
  type SourceInfo,
...
import { CertificateData } from '@vechain/sdk-core1.2';
import { SignTypedDataOptions } from '@vechain/sdk-network1.2';
...
export type VechainKitProviderProps = {
  ...
  network: {
    ...
    connectionCertificate?: {
      message?: Pick<CertificateData, 'purpose' | 'payload'>;
