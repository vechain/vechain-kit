...
import type {
  ITokenAuction,
  ITokenAuctionInterface,
} from "../../../contracts/interfaces/ITokenAuction";
...
export class ITokenAuction__factory {
  static readonly abi = _abi;
  static createInterface(): ITokenAuctionInterface {
    return new Interface(_abi) as ITokenAuctionInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ITokenAuction {
    return new Contract(address, _abi, runner) as unknown as ITokenAuction;
  }
}
