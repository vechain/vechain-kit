...
import type {
  IGalaxyMember,
  IGalaxyMemberInterface,
} from "../../../contracts/interfaces/IGalaxyMember";
...
export class IGalaxyMember__factory {
  static readonly abi = _abi;
  static createInterface(): IGalaxyMemberInterface {
    return new Interface(_abi) as IGalaxyMemberInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IGalaxyMember {
    return new Contract(address, _abi, runner) as unknown as IGalaxyMember;
  }
}
