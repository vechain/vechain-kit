...
import type {
  ...
  RoundEarningsSettingsUpgradeableV1Interface,
} from "../../../../../../contracts/deprecated/V1/x-allocation-voting-governance/modules/RoundEarningsSettingsUpgradeableV1";
...
export class RoundEarningsSettingsUpgradeableV1__factory {
  static readonly abi = _abi;
  static createInterface(): RoundEarningsSettingsUpgradeableV1Interface {
    return new Interface(_abi) as RoundEarningsSettingsUpgradeableV1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as RoundEarningsSettingsUpgradeableV1;
  }
}
