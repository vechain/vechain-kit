...
import type {
  ...
  RoundVotesCountingUpgradeableV1Interface,
} from "../../../../../../contracts/deprecated/V1/x-allocation-voting-governance/modules/RoundVotesCountingUpgradeableV1";
...
export class RoundVotesCountingUpgradeableV1__factory {
  static readonly abi = _abi;
  static createInterface(): RoundVotesCountingUpgradeableV1Interface {
    return new Interface(_abi) as RoundVotesCountingUpgradeableV1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as RoundVotesCountingUpgradeableV1;
  }
}
