...
import type {
  ...
  RoundFinalizationUpgradeableInterface,
} from "../../../../../../contracts/deprecated/V3/x-allocation-voting-governance/modules/RoundFinalizationUpgradeable";
...
export class RoundFinalizationUpgradeable__factory {
  static readonly abi = _abi;
  static createInterface(): RoundFinalizationUpgradeableInterface {
    return new Interface(_abi) as RoundFinalizationUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as RoundFinalizationUpgradeable;
  }
}
