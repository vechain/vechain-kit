...
export interface GovernorVotesLogicV3Interface extends Interface {
  getEvent(
...
export interface GovernorVotesLogicV3 extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorVotesLogicV3;
  waitForDeployment(): Promise<this>;

  interface: GovernorVotesLogicV3Interface;
