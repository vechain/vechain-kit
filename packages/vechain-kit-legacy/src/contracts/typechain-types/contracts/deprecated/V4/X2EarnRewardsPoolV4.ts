...
export interface X2EarnRewardsPoolV4Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface X2EarnRewardsPoolV4 extends BaseContract {
  connect(runner?: ContractRunner | null): X2EarnRewardsPoolV4;
  waitForDeployment(): Promise<this>;

  interface: X2EarnRewardsPoolV4Interface;
