...
export interface PassportDelegationLogicV2Interface extends Interface {
  getEvent(
...
export interface PassportDelegationLogicV2 extends BaseContract {
  connect(runner?: ContractRunner | null): PassportDelegationLogicV2;
  waitForDeployment(): Promise<this>;

  interface: PassportDelegationLogicV2Interface;
