...
export interface PassportEntityLogicV2Interface extends Interface {
  getEvent(
...
export interface PassportEntityLogicV2 extends BaseContract {
  connect(runner?: ContractRunner | null): PassportEntityLogicV2;
  waitForDeployment(): Promise<this>;

  interface: PassportEntityLogicV2Interface;
