...
export interface VeBetterPassportV2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface VeBetterPassportV2 extends BaseContract {
  connect(runner?: ContractRunner | null): VeBetterPassportV2;
  waitForDeployment(): Promise<this>;

  interface: VeBetterPassportV2Interface;
