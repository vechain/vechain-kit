...
export interface EndorsementUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "addAppModerator"
...
export interface EndorsementUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): EndorsementUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: EndorsementUpgradeableInterface;
