...
export interface X2EarnAppsUpgradeableV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "addApp"
...
export interface X2EarnAppsUpgradeableV1 extends BaseContract {
  connect(runner?: ContractRunner | null): X2EarnAppsUpgradeableV1;
  waitForDeployment(): Promise<this>;

  interface: X2EarnAppsUpgradeableV1Interface;
