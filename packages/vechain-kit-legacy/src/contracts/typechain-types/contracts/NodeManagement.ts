...
export declare namespace NodeManagement {
  export type NodeInfoStruct = {
    nodeId: BigNumberish;
    nodeLevel: BigNumberish;
    xNodeOwner: AddressLike;
...
export interface NodeManagementInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "UPGRADER_ROLE"
...
export interface NodeManagement extends BaseContract {
  connect(runner?: ContractRunner | null): NodeManagement;
  ...
  getUserNodes: TypedContractMethod<
    [user: AddressLike],
    [NodeManagement.NodeInfoStructOutput[]],
    "view"
  >;
