...
export declare namespace IEmissions {
...
export interface IEmissionsInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    ...
    values: [IEmissions.InitializationDataStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isEmissionsNotAligned",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface IEmissions extends BaseContract {
  connect(runner?: ContractRunner | null): IEmissions;
  waitForDeployment(): Promise<this>;

  interface: IEmissionsInterface;
  ...
  emissions: TypedContractMethod<
    [cycle: BigNumberish],
    [IEmissions.EmissionStructOutput],
    "view"
  >;
  ...
  initialize: TypedContractMethod<
    [data: IEmissions.InitializationDataStruct],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "isEmissionsNotAligned"
